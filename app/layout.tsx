...
export const metadata: Metadata = {
  ...
  description: "Paribesh Shrestha - Full Stack Developer specializing in React, Next.js, TypeScript, and modern web technologies. Building innovative digital solutions with clean code and exceptional user experiences.",
  keywords: [
    "Paribesh Shrestha",
